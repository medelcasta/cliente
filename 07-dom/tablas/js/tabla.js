...
function creoTabla(){
    ...
    for(i = 0; i< tam; i++){
        ...
        for(let j = 0; i< tam; j++){
            ...
            // Añadir un manejador de eventos para cambiar el color al hacer click en la celda oporturna
...
function cambiarColorCelda(celda){
    celda.style.backgroundColor = celda.style.backgroundColor === 'blue' ? 'pink' : 'blue';
